...
const Contact = () => {
  const handleContact = async (data) => {
    ...
    emailjs
      .send('service_brk7wkd', 'template_ds889do', data, {
        publicKey: 'wlv21s4DmocqUl17A',
      })
      .then(
        () => {
                ...
                <ul className="contact">
                  <li>
                    ...
                    <div>
                      <h3>Address:</h3>
                      <p>
                        RC-561/13, Pragati Vihar Khora Colony, Ghaziabad, U.P.,
                        India
                      </p>
                    </div>
                  </li>
                  <li>
                    ...
                    <div>
                      <h3>Telephone:</h3>
                      <p>Tel: +91 8130230062</p>
                      <p>Tel: +91 9868015943</p>
                    </div>
                  </li>
                  <li>
                    <svg
