    ...
    <Layouts>
        ...
        <section className="gap contact-form-2">
            ...
            <div className="row">
                ...
                <div>
                    <img src="/images/contsct-page-1.jpg" style={{objectFit:"contain"}} width={"100%"} height={"50%"}/>
                </div>
                <div className="info">
                    <ul className="contact">
                        <li>
                            ...
                            <div>
                                <h3>Address:</h3>
                                <p>RC-561/13, Pragati Vihar Khora Colony, Ghaziabad, U.P., India</p>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div>
                                <h3>Email:</h3>
                                <p>jsenterprises9868@gmail.com</p>
                            </div>
                        </li>
                    </ul>
