          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="who-we-are">
                ...
                <figure>
                  <img className="w-100" src="/images/about-page-1.jpg" alt="About Image One" />
                </figure>
              </div>
            </div>
            <div className="col-lg-5 offset-lg-1">
              <div className="who-we-are space">
                ...
                <figure>
                  <img className="w-100" src="/images/about-page-2.jpg" alt="About Image Two" />
                </figure>
              </div>
            </div>
          </div>
      ...
      <section className="gap about-how-it-works light-bg-color">
        ...
        <div className="container">
          <figure style={{"position": "relative", "zIndex": "9"}}>
            <img className="w-100" src="/images/about-page-3.jpg" alt="About How It Works" />
          </figure>
        </div>
        <div className="container">
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6" >
              <div className="data">
                <figure>
                  <img className="w-100" src="/images/about-page-4.jpeg" alt="About key Benefits" />
                </figure>
              </div>
            </div>
            <div className="col-lg-6" >
