      ...
      <div className="container">
        <div className="row">
                  ...
                  <div className="d-flex-all justify-content-between">
                    ...
                    <div className="nav-bar">
                      ...
                      <div className="extras">
                        ...
                        {contactButton != 1 && (
                          <a href="tel:+91 8130230062" className="theme-btn">
                           +91 8130230062
                            <i>
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="mobile-nav desktop-menu">
            ...
            <figure>
              <img src="/images/home-page-8.jpg" alt="image" />
            </figure>

            <h3>Get in touch</h3>
            <p className="num">+91 8130230062</p>
            <p className="adrs">
            RC-561/13, Pragati Vihar Khora Colony, Ghaziabad, U.P., India
            </p>
